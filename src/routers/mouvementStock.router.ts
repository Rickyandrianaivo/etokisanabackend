...
import { MouvementStock, MouvementStockModel } from '../models/mouvementStock.model';
...
router.post("/create",asyncHandler(
    async(req,res) => {
        ...
        const { 
            ...
            depot,
            codeSociete,
            numeroLigne} : MouvementStock = req.body;
...
router.post("/createArray",asyncHandler(async(req,res) => {
        ...
        mouvementStocks.forEach(async(mouvementStock : any) => {
            const newMouvementStock = {

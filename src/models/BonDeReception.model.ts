...
export const BonDeReceptionSchema = new Schema<IBonDeReception>({
...
export const BonDeReceptionModel = model<IBonDeReception>('bonDeReception',BonDeReceptionSchema)
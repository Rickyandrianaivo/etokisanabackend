...
router.get("/", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, factureVenteDetails_model_1.FactureVenteDetailsModel.find()];
            case 1:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4, factureVenteDetails_model_1.FactureVenteDetailsModel.find({ designation: { $regex: searchRegex } })];
            case 1:
                factureVentes = _a.sent();
                res.send(factureVentes);
                return [2];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4, factureVenteDetails_model_1.FactureVenteDetailsModel.find({ factureVenteNumDoc: numeroDoc }).populate('article')];
            case 1:
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4, pointDeVente_model_1.PointDeVenteModel.updateOne({ _id: pV._id }, { $set: { numeroVente: numeroVente } })];
            case 2:
                _b.sent();
                _b.label = 3;
            case 3:
                ...
                return [4, factureVenteDetails_model_1.FactureVenteDetailsModel.create(newFactureVenteDetails)];
            case 4:
                _b.sent();
                newQteStock = cartItem.article.qteEnStock - newFactureVenteDetails.quantite;
                return [4, article_model_1.ArticleModel.updateOne({ _id: cartItem.article._id }, { $set: { qteEnStock: newQteStock } })];
            case 5:
                _b.sent();

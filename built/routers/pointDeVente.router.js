    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4, pointDeVente_model_1.PointDeVenteModel.updateOne(updatedPV)];
            case 1:
                _b.sent();
                res.send("PV updated!");
                return [2];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                if (!pointDeVente) return [3, 3];
                newNumeroVente = pointDeVente.numeroVente + 1;
                newNumeroMvStock = pointDeVente.numeroMouvementStock + 1;
                return [4, pointDeVente_model_1.PointDeVenteModel.updateOne({ _id: pointDeVente.id }, { $set: { numeroVente: newNumeroVente, numeroMouvementStock: newNumeroMvStock } })];
            case 2:
                _a.sent();
                _a.label = 3;
            case 3: return [2];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                newNumeroMvStock = pointDeVente.numeroMouvementStock + 1;
                return [4, pointDeVente_model_1.PointDeVenteModel.updateOne({ _id: pointDeVente.id }, { $set: { numeroBS: newNumeroBE, numeroMouvementStock: newNumeroMvStock } })];
            case 2:
                _a.sent();
                _a.label = 3;
            case 3: return [2];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                newNumeroMvStock = pointDeVente.numeroMouvementStock + 1;
                return [4, pointDeVente_model_1.PointDeVenteModel.updateOne({ _id: pointDeVente.id }, { $set: { numeroBS: newNumeroBS, numeroMouvementStock: newNumeroMvStock } })];
            case 2:
                _a.sent();
                _a.label = 3;
            case 3: return [2];

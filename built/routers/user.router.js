    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4, user_model_1.UserModel.findOne({ name: name })];
            case 1:
                user = _b.sent();
                if (user) {
            ...
            case 2:
                ...
                return [4, user_model_1.UserModel.create(newUser)];
            case 3:
                dbUser = _b.sent();
...
router.get("/", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, user_model_1.UserModel.find()];
            case 1:
                users = _a.sent();
                res.send(users);
                return [2];
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4, user_model_1.UserModel.updateOne({ id: userId }, userUpdates)];
            case 1:
                _b.sent();
                return [2];
        }
...
router.get("/resetTable", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, factureVente_model_1.FactureVenteModel.countDocuments()];
            case 1:
                factureVenteCount = _a.sent();
                return [4, factureVenteDetails_model_1.FactureVenteDetailsModel.countDocuments()];
            case 2:
                factureVenteDetailsCount = _a.sent();
                return [4, bonEntree_model_1.BonEntreeModel.countDocuments()];
            case 3:
                bonEntreeCount = _a.sent();
                return [4, bonEntreeDetails_model_1.BonEntreeDetailsModel.countDocuments()];
            case 4:
                bonEntreeDetailsCount = _a.sent();
                return [4, bonSortie_model_1.BonSortiesModel.countDocuments()];
            case 5:
                bonSortiesCount = _a.sent();
                return [4, bonSortieDetails_model_1.BonSortiesDetailsModel.countDocuments()];
            case 6:
                bonSortiesDetailsCount = _a.sent();
                return [4, inventaireDetail_model_1.InventaireDetailModel.countDocuments()];
            case 7:
                inventaireDetailCount = _a.sent();
                return [4, inventaire_model_1.InventaireModel.countDocuments()];
            case 8:
                inventaireCount = _a.sent();
                return [4, mouvementStock_model_1.MouvementStockModel.countDocuments()];
            case 9:
                ...
                if (!(factureVenteCount > 0 ||
                    ...
                    inventaireCount > 0 ||
                    mouvementStockCount > 0)) return [3, 20];
                return [4, factureVente_model_1.FactureVenteModel.deleteMany({})];
            case 10:
                _a.sent();
                return [4, factureVenteDetails_model_1.FactureVenteDetailsModel.deleteMany({})];
            case 11:
                _a.sent();
                return [4, bonEntree_model_1.BonEntreeModel.deleteMany({})];
            case 12:
                _a.sent();
                return [4, bonEntreeDetails_model_1.BonEntreeDetailsModel.deleteMany({})];
            case 13:
                _a.sent();
                return [4, bonSortie_model_1.BonSortiesModel.deleteMany({})];
            case 14:
                _a.sent();
                return [4, bonSortieDetails_model_1.BonSortiesDetailsModel.deleteMany({})];
            case 15:
                _a.sent();
                return [4, inventaireDetail_model_1.InventaireDetailModel.deleteMany({})];
            case 16:
                _a.sent();
                return [4, inventaire_model_1.InventaireModel.deleteMany({})];
            case 17:
                _a.sent();
                return [4, mouvementStock_model_1.MouvementStockModel.deleteMany({})];
            case 18:
                _a.sent();
                return [4, pointDeVente_model_1.PointDeVenteModel.updateOne({}, {
                        $set: {
                            numeroBE: 1,
                            numeroBS: 1,
                            numeroInventaire: 1,

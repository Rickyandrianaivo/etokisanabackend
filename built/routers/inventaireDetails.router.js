    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4, inventaireDetail_model_1.InventaireDetailModel.find({ inventaireNumDoc: numeroDocument })];
            case 1:
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4, inventaireDetail_model_1.InventaireDetailModel.create(inventaireDetail)];
                                case 1:
                                    _a.sent();
                                    return [4, article_model_1.ArticleModel.updateOne({ _id: element.article._id }, { $set: { qteEnStock: element.stockPhysique } })];
                                case 2:
                                    _a.sent();
                                    return [2];
                            }
...
router.get("/:numeroDocument/search/:searchTerm", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var searchRegex, inventairesDetails;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                searchRegex = new RegExp(req.params['searchTerm'], 'i');
                return [4, inventaireDetail_model_1.InventaireDetailModel.find({ article: { $regex: searchRegex } })];
            case 1:
                inventairesDetails = _a.sent();

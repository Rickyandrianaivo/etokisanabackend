...
router.get("/", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _b = (_a = res).send;
                return [4, factureVente_model_1.FactureVenteModel.find()];
            case 1:
                _b.apply(_a, [_c.sent()]);
                return [2];
        }
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4, factureVente_model_1.FactureVenteModel.find({ date: { $gte: new Date(dateDu), $lte: new Date(dateAu) } })];
            case 1:
                factureVentes = _a.sent();
                return [3, 4];
            case 2: return [4, factureVente_model_1.FactureVenteModel.find()];
            case 3:
                factureVentes = _a.sent();
                _a.label = 4;
            case 4:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4, factureVente_model_1.FactureVenteModel.find({ designation: { $regex: searchRegex } })];
            case 1:
                factureVentes = _a.sent();
                res.send(factureVentes);
                return [2];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4, factureVente_model_1.FactureVenteModel.findOne({ numeroDocument: numeroDoc })];
            case 1:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4, article_model_1.ArticleModel.findOne({ reference: reference })];
            case 1:
                article = _a.sent();
                res.send(article);
                return [2];
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4, factureVente_model_1.FactureVenteModel.create(newFactureVente)];
            case 1:
                _b.sent();

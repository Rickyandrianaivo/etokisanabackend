...
router.get("/", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _b = (_a = res).send;
                return [4, inventaire_model_1.InventaireModel.find()];
            case 1:
                _b.apply(_a, [_c.sent()]);
                return [2];
        }
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4, inventaire_model_1.InventaireModel.find({ date: { $gte: dateDu, $lte: dateAu } })];
            case 1:
                precInv = _a.sent();
                return [3, 4];
            case 2: return [4, inventaire_model_1.InventaireModel.find()];
            case 3:
                precInv = _a.sent();
                _a.label = 4;
            case 4:
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4, inventaireDetail_model_1.InventaireDetailModel.find({ inventaireNumDoc: numeroDocument }).populate("article")];
            case 1:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4, pointDeVente_model_1.PointDeVenteModel.updateOne({ _id: pV._id }, { $set: { numeroInventaire: newNumInv } })];
            case 2:
                _a.sent();
                return [4, inventaire_model_1.InventaireModel.create(newInventaire)];
            case 3:
                _a.sent();
                ...
                Inventaire_data_1.sample_inventaireDetails.forEach(function (element) { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4, article_model_1.ArticleModel.findOne({ reference: element.reference })];
                            case 1:
                                theArticle = _a.sent();
                                ...
                                return [4, inventaireDetail_model_1.InventaireDetailModel.create(newInventaireDetails)];
                            case 2:
                                _a.sent();
                                _a.label = 3;
                            case 3: return [2];

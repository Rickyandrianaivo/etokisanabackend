...
router.get("/", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, bonEntreeDetails_model_1.BonEntreeDetailsModel.find().populate('article')];
            case 1:
...
router.get("/:numeroDocument", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, bonEntreeDetails_model_1.BonEntreeDetailsModel.find({ bonEntreeNumDoc: req.params['numeroDocument'] }).populate('article')];
            case 1:
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                _b.sent();
                _b.label = 3;
            case 3: return [4, bonEntreeDetails_model_1.BonEntreeDetailsModel.create(newBonEntreeDetail)];
            case 4:
                _b.sent();
...
//# sourceMappingURL=bonEntreesDetails.router.js.map
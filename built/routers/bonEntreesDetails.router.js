...
import { BonEntreeDetailsModel } from '../models/bonEntreeDetails.model';
...
router.post("/create", asyncHandler(async (req, res) => {
    const { article, quantiteCommande, quantiteEntree, montantNetHT, montantTVA, montantNetTTC, bonEntreeNumDoc } = req.body;
    const newBonEntreeDetail = {
        article: article._id,
        quantiteCommande,
        quantiteEntree,
        montantNetHT,

...
router.get("/", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, bonSortieDetails_model_1.BonSortiesDetailsModel.find().populate('article')];
            case 1:
...
router.get("/:numeroDocument", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, bonSortieDetails_model_1.BonSortiesDetailsModel.find({ bonSortieNumDoc: req.params['numeroDocument'] }).populate('article')];
            case 1:
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                _b.sent();
                _b.label = 3;
            case 3: return [4 /*yield*/, bonSortieDetails_model_1.BonSortiesDetailsModel.create(newBonSortieDetail)];
            case 4:
                _b.sent();

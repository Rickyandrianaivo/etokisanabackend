...
router.get("/seed", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, article_models_1.ArticleModel.countDocuments()];
            case 1:
                ...
                return [4 /*yield*/, article_models_1.ArticleModel.create(data_1.sample_articles)];
            case 2:
                _a.sent();
...
router.get("/", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, article_models_1.ArticleModel.find()];
            case 1:
                articles = _a.sent();
                res.send(articles);
                return [2 /*return*/];
...
router.get("/search/:searchTerm", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var searchRegex, articles;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                searchRegex = new RegExp(req.params['searchTerm'], 'i');
                return [4 /*yield*/, article_models_1.ArticleModel.find({ designation: { $regex: searchRegex } })];
            case 1:
                articles = _a.sent();
                res.send(articles);
                return [2 /*return*/];
...
router.get("/id/:id", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params['id'];
                return [4 /*yield*/, article_models_1.ArticleModel.findOne({ _id: id })];
            case 1:
                article = _a.sent();
                res.send(article);
                return [2 /*return*/];
...
router.get("/famille/:famille", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, article_models_1.ArticleModel.find({ categorie: req.params['famille'] })];
            case 1:
                articles = _a.sent();
                res.send(articles);
                return [2 /*return*/];

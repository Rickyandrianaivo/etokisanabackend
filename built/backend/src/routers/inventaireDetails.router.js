    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, inventaireDetail_model_1.InventaireDetailModel.find({ inventaireNumDoc: numeroDocument })];
            case 1:
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, inventaireDetail_model_1.InventaireDetailModel.create(inventaireDetail)];
                                case 1:
                                    _a.sent();
                                    return [4 /*yield*/, article_models_1.ArticleModel.updateOne({ _id: element.article._id }, { $set: { qteEnStock: element.stockPhysique } })];
                                case 2:
                                    _a.sent();
                                    return [2 /*return*/];
                            }
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, inventaireDetail_model_1.InventaireDetailModel.find({ article: { $regex: searchRegex } })];
            case 1:
